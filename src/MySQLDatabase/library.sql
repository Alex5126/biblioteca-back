...
-- Volcando datos para la tabla library.books: ~5 rows (aproximadamente)
DELETE FROM `books`;
...
-- Volcando estructura para tabla library.loan_applications
...
-- Volcando datos para la tabla library.loan_applications: ~0 rows (aproximadamente)
DELETE FROM `loan_applications`;
/*!40000 ALTER TABLE `loan_applications` DISABLE KEYS */;
INSERT INTO `loan_applications` (`id`, `id_user`, `id_book`, `status`, `date`, `update_date`) VALUES
...
-- Volcando estructura para tabla library.loan_history
...
-- Volcando datos para la tabla library.loan_history: ~1 rows (aproximadamente)
